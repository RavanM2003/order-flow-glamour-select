...
export class StaffService extends ApiService {
  ...
  async getById(id: number | string): Promise<ApiResponse<Staff>> {
    if (config.usesMockData) {
      ...
      if (
        staffData &&
        typeof staffData === "object" &&
        "commissionRate" in staffData &&
        staffData.commissionRate !== undefined
      )
      ...
      if (
        staffData &&
        typeof staffData === "object" &&
        "paymentType" in staffData &&
        staffData.paymentType !== undefined
      )
  ...
  async update(
    ...
    if (config.usesMockData) {
      ...
      if (index >= 0) {
        ...
        const existingStaff =
          mockStaff[index] || this.createDefaultStaff(Number(id));
        ...
        if (
          ...
          (existingStaff &&
            typeof existingStaff === "object" &&
            "email" in existingStaff &&
            existingStaff.email !== undefined)
        ) {
          updatedStaff.email =
            data.email ||
            (existingStaff &&
        ...
        if (
          ...
          (existingStaff &&
            typeof existingStaff === "object" &&
            "phone" in existingStaff &&
            existingStaff.phone !== undefined)
        ) {
          updatedStaff.phone =
            data.phone ||
            (existingStaff &&
        ...
        if (
          ...
          (existingStaff &&
            typeof existingStaff === "object" &&
            "role_id" in existingStaff &&
            existingStaff.role_id !== undefined)
        ) {
        ...
        if (
          ...
          (existingStaff &&
            typeof existingStaff === "object" &&
            "avatar_url" in existingStaff &&
            existingStaff.avatar_url !== undefined)
        ) {
          updatedStaff.avatar_url =
            data.avatar_url ||
            (existingStaff &&
            typeof existingStaff === "object" &&
            "avatar_url" in existingStaff
              ? String(existingStaff.avatar_url)
              : "");
        }
        ...
        if (
          ...
          (existingStaff &&
            typeof existingStaff === "object" &&
            "salary" in existingStaff &&
            existingStaff.salary !== undefined)
        ) {
          updatedStaff.salary =
            data.salary ||
            (existingStaff &&
        ...
        if (
          ...
          (existingStaff &&
            typeof existingStaff === "object" &&
            "commissionRate" in existingStaff &&
            existingStaff.commissionRate !== undefined)
        ) {
          updatedStaff.commissionRate =
            data.commissionRate ||
            (existingStaff &&
            typeof existingStaff === "object" &&
            "commissionRate" in existingStaff
              ? Number(existingStaff.commissionRate)
              : 0);
        }
        ...
        if (
          ...
          (existingStaff &&
            typeof existingStaff === "object" &&
            "paymentType" in existingStaff &&
            existingStaff.paymentType !== undefined)
        ) {
          updatedStaff.paymentType =
            data.paymentType ||
            (existingStaff &&
            typeof existingStaff === "object" &&
            "paymentType" in existingStaff
              ? String(existingStaff.paymentType)
              : "");
        }
  ...
  async getPayments(id: number | string): Promise<ApiResponse<StaffPayment[]>> {
    if (config.usesMockData) {
      await new Promise((resolve) => setTimeout(resolve, 200));
      const payments = mockStaffPayments.filter(
        (p) => p.staff_id === Number(id)
      );
  ...
  async getServiceRecords(
    id: number | string
  ): Promise<ApiResponse<StaffServiceRecord[]>> {
    if (config.usesMockData) {
      await new Promise((resolve) => setTimeout(resolve, 200));
      const records = mockServiceRecords.filter(
        (r) => r.staff_id === Number(id)
      );
      return { data: [...records] };
    }
  ...
  > {
    if (config.usesMockData) {
      ...
      const commission = payments
        .filter(
          (p) => p.payment_type === "commission" || p.type === "commission"
        )
        .reduce((sum, p) => sum + p.amount, 0);
  ...
  async updateWorkingHours(
    ...
    if (config.usesMockData) {
      ...
      const index = mockWorkingHours.findIndex(
        (h) => h.staff_id === Number(staffId) && h.day_of_week === dayOfWeek
      );
      ...
      if (index >= 0) {
        ...
        const updatedHours: StaffWorkingHours = {
          ...
          is_day_off:
            hours.is_day_off !== undefined
              ? hours.is_day_off
              : mockWorkingHours[index].is_day_off,
        };
  ...
  private createDefaultWorkingHours(staffId: number): void {
    if (config.usesMockData) {
      ...
      daysOfWeek.forEach((day) => {
        ...
        const newId =
          Math.max(...mockWorkingHours.map((h) => h.id || 0), 0) + 1 + day;
  ...
  async checkAvailability(
    ...
    if (config.usesMockData) {
      ...
      const workingHoursForDay = mockWorkingHours.find(
        (h) => h.staff_id === Number(staffId) && h.day_of_week === dayOfWeek
      );
    ...
    return this.get(
      `/staff/${staffId}/availability?date=${date.toISOString()}`
    );
  }
}
