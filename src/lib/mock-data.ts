...
export const mockStaff = [
  ...
  },
  {
    ...
    name: "Kamran Əhmədov",
    position: "Barber",
    specializations: ["Men Haircuts", "Shaving"],
    created_at: "2024-01-01T00:00:00.000Z",
    updated_at: "2024-01-01T00:00:00.000Z",
    user_id: "user4",
  },
  {
    ...
    specializations: ["Facials", "Waxing"],
    created_at: "2024-01-01T00:00:00.000Z",
    updated_at: "2024-01-01T00:00:00.000Z",
    user_id: "user5",
  },
...
export const mockProducts = [
  ...
  },
  {
    ...
    price: 75,
    description: "Premium anti-aging formula with collagen",
  },
  {
    id: 3,
    name: "Massage Oil",
    price: 35,
    description: "Natural oils blend for body massage",
  },
  {
    id: 4,
    name: "Nail Care Kit",
    price: 30,
    description: "Complete kit for nail maintenance",
  },
  {
    id: 5,
    name: "Hair Care Kit",
    price: 60,
    description: "Complete kit for healthy hair",
  },
  {
    id: 6,
    name: "Hair Spray",
  ...
  },
  {
    ...
    price: 55,
    description: "Professional quality makeup brushes",
  },
];
  ...
  for (let day = 0; day < 10; day++) {
    ...
    for (let i = 0; i < appointmentsPerDay; i++) {
      ...
      const appointment = {
        ...
        remainingBalance,
        rejectionReason:
          status === "rejected" ? "Customer canceled appointment" : "",
      };
