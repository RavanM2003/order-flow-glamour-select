        ...
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button
              ...
              className={isActive("/services") ? "bg-glamour-700" : ""}
              asChild
            >
            ...
            <Button
              ...
              className={isActive("/products") ? "bg-glamour-700" : ""}
              asChild
            >
            ...
            <Button
              ...
              className={isActive("/about") ? "bg-glamour-700" : ""}
              asChild
            >
            ...
            <Button
              ...
              className={isActive("/contact") ? "bg-glamour-700" : ""}
              asChild
            >
