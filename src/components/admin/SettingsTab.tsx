...
const SettingsTab = () => {
  ...
  const handleBankSubmit = (e: React.FormEvent) => {
    ...
    if (editMode && selected) {
      setBanks(
        banks.map((b) => (b.id === selected.id ? { ...b, ...bankForm } : b))
      );
      setEditMode(false);
      setSelected(null);
    } else {
        ...
        <TabsContent value="general" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Update your company details that will be displayed on the
                website
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <form className="space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Customers will be able to book appointments up to{" "}
                    {maxBookingDays} days in advance.
                  </p>
                </div>
        ...
        <TabsContent value="banks" className="mt-6">
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-bold text-glamour-800">
                Bank Hesabları
              </h2>
              <Button
          ...
          >
            <form className="space-y-4 p-2" onSubmit={handleBankSubmit}>
              ...
              <Button
                type="submit"
                className="bg-glamour-700 text-white w-full"
              >
          ...
          <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
            <DialogContent>
              <DialogHeader>
                Bank hesabını silmək istədiyinizə əminsiniz?
              </DialogHeader>
