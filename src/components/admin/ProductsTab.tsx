...
const AddProductForm = ({
  ...
  <form onSubmit={handleAddProduct} className="space-y-4 p-4">
    ...
    <div>
      <label htmlFor="add-product-details" className="block mb-1 font-medium">
        Details
      </label>
      <textarea
    ...
    <div>
      <fieldset>
        <legend className="block mb-1 font-medium">Related Services</legend>
          ...
          {allServices.map((service) => (
            <button
              ...
              className={`px-3 py-1 rounded-full border text-xs ${
                newProduct.relatedServices.includes(service)
    ...
    {addProductError && (
      <div className="text-red-600 text-sm">{addProductError}</div>
    )}
    <Button
      type="submit"
...
const EditProductForm = ({
  ...
  <form onSubmit={handleEditProductSubmit} className="space-y-4 p-4">
    ...
    <div>
      <label htmlFor="edit-product-details" className="block mb-1 font-medium">
        Details
      </label>
      <textarea
        ...
        onChange={(e) =>
          setEditProductForm({ ...editProductForm, details: e.target.value })
        }
        required
      />
    </div>
    <div>
      ...
      <textarea
        ...
        onChange={(e) =>
          setEditProductForm({ ...editProductForm, howToUse: e.target.value })
        }
        required
      />
    </div>
        ...
        <div className="flex flex-wrap gap-2">
          {allServices.map((service) => (
            <button
              ...
              key={service}
              className={`px-3 py-1 rounded-full border text-xs ${
                editProductForm.relatedServices.includes(service)
                  ? "bg-glamour-700 text-white border-glamour-700"
                  : "bg-white text-glamour-800 border-gray-300"
              }`}
              onClick={() => {
    ...
    {editProductError && (
      <div className="text-red-600 text-sm">{editProductError}</div>
    )}
    <Button
      type="submit"
      className="bg-glamour-700 hover:bg-glamour-800 text-white w-full"
  ...
  const [products, setProducts] = useState([
    {
      ...
      details: "Size: 30ml\nCategory: Skin Care",
      howToUse:
        "Apply 2-3 drops to clean, dry skin in the evening. Gently pat into skin and allow to absorb before applying moisturizer. Start using 2-3 times per week, gradually increasing to nightly use as tolerated. Always use sunscreen during daytime when using this product.",
      ingredients:
        "Water, Propylene Glycol, Glycerin, Retinol, Palmitoyl Tripeptide-1, Palmitoyl Tetrapeptide-7, Sodium Hyaluronate, Hydrolyzed Collagen, Ascorbic Acid, Tocopheryl Acetate, Niacinamide, Panthenol, Allantoin, Phenoxyethanol, Ethylhexylglycerin.",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      stock: 15,
      category: "Hair Care",
      relatedServices: ["Hair Styling", "Hair Treatment"],
    },
    {
      id: 4,
    ...
    },
    {
      ...
      stock: 12,
      category: "Makeup",
      relatedServices: ["Makeup Application"],
    },
    {
      id: 6,
      name: "Nail Care Set",
      ...
      stock: 20,
      category: "Nail Care",
      relatedServices: ["Manicure", "Pedicure"],
    },
    {
      id: 7,
      name: "Body Scrub",
      ...
      stock: 22,
      category: "Body Care",
      relatedServices: ["Body Treatment"],
    },
    {
      id: 8,
    ...
    },
    {
      ...
      stock: 25,
      category: "Body Care",
      relatedServices: ["Massage Therapy"],
    },
    {
      id: 12,
      name: "Hair Mask",
      ...
      stock: 20,
      category: "Hair Care",
      relatedServices: ["Hair Treatment"],
    },
  ]);
